...
jQuery(document).ready(function() {
    jQuery("img.class_in_img").lazy();
});
</script>

<img class="class_in_img" data-src="http://site.com/img/image_to_load.jpg" style="width: 55px; height: 55px;" src="http://site.com/img/image_placeholder_optional.jpg">
 *
 */
