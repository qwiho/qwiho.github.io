...
<script type="text/javascript">
      $(function() {
          $(".class_in_img").lazyload({
              effect : "fadeIn"
          });
      });
</script>

<img class="class_in_img" data-original="http://site.com/img/image_to_load.jpg" style="width: 55px; height: 55px;" src="http://site.com/img/image_placeholder_optional.jpg">
 *
 */
